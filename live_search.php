<html>
	...
	<link rel="stylesheet" href="css/index.css" />	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
		...
		<link href="css/bootstrapn.min.css" rel="stylesheet" />
	</head>
...
<div class="container">
  ...
  transition: width 0.4s ease-in-out;" type="text" name="search_text" id="search_text" placeholder="Search by any details" class="form-control" /></center>
				</div>
			</div>
			<br />
			<div id="result"></div>
