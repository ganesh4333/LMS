...
<h2>Login To Click Here...</h2>

<button onclick="document.getElementById('id01').style.display='block'" style="width:auto;">Librarian Login</button>

<br/><br/>
<div class="stdb"><a href="std/std_login.php" style="width:auto;">Student Login</a></div>
...
<div id="id01" class="modal">
  ...
  <form class="modal-content animate" action="" method="post" name="login" >
    <div class="imgcontainer">
      ...
      <img src="http://suratdiesels.com/images/login_1.png" alt="Avatar" class="avatar">
    </div>
